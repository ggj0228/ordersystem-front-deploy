<template>
  <v-container>
    <v-row justify="center">
      <v-col cols="6">
        <v-card>
          <v-card-title class="text-h5 text-center">상품등록</v-card-title>
          <v-card-text>
            <v-form>
              <v-text-field
                label="상품명"
              ...
              <v-row>
                <v-col>
                  ...
                  <v-btn color="primary" block @click="productCreate()">등록</v-btn>
                </v-col>
              </v-row>
            </v-form>
          </v-card-text>
...
export default {
  ...
  methods:{
    ...
    async productCreate() {
        // multi-part-formdata 또는 url인코딩 방식인 경우에 FormData클래스 사용해서 객체를 조립함
        try{
